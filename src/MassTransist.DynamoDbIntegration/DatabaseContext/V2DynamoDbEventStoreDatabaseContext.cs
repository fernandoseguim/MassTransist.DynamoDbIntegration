...
{
    public class V2DynamoDbEventStoreDatabaseContext : IDynamoDbEventStoreDatabaseContext
    {
        public V2DynamoDbEventStoreDatabaseContext(IAmazonDynamoDB dynamoDb, DynamoDbEventStoreOptions options)
        {
        ...
        {
            var request = new V2DynamoDbEventStoreTableRequest(Options);
