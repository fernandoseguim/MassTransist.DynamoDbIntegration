...
{
    public class V2EventRouter
    {
        private readonly Dictionary<Type, Action<object>> _handlers;

        /// <summary>
        /// Initializes a new instance of the <see cref="V2EventRouter"/> class.
        /// </summary>
        public V2EventRouter() => _handlers = new Dictionary<Type, Action<object>>();
